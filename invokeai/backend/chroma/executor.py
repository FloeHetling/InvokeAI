    ...
    def __call__(
        ...
        *,
        ...
        if controlnet_double_block_residuals is not None and len(controlnet_double_block_residuals) != len(
            ...
            raise ValueError("Chroma ControlNet double-block residual count does not match the transformer block count")
        if controlnet_single_block_residuals is not None and len(controlnet_single_block_residuals) != len(
            ...
            raise ValueError("Chroma ControlNet single-block residual count does not match the transformer block count")
